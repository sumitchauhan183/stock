          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Add New Trainer </h6>
              </div>
            </div>
            <div class="card-body">
              @if(session('error'))
                                ...
                                @endif
                <form role="form" class="text-center" method="POST" action="{{ route('admin.trainer.add') }}" enctype="multipart/form-data">
                @csrf
