		...
		<div class="container" style="margin-top:100px;">
			...
			<div class="row">
				<div class="col-xxl-12 mb-30">
					<div class="card card-statistics h-100 p-0 mb-0" style="margin: 0 80px;">						
						<div class="card-body">
							<div class="CotentWrapper">
								<div><h2 style="text-align:center;color:#016598;" class="">FIND VALUE STOCKS</h2></div>								
								<form action="by-sector.php" >
