				...
				<div class="col-md-12 m-b-30">
					<div class="d-block d-lg-flex flex-nowrap align-items-center">
						<div class="page-title mr-4 pr-4">
							<h1><img src="{{ asset('images/flag_icon1.png')}}"> <a href="{{route('user.tools.find_value_stock')}}" style="color:#016598;font-weight:600;">Find all Stocks ></a> 
							<a href="{{route('user.stock.assets')}}" style="color:#016598;font-weight:600;">By Asset Class > </a> Companies</h1>
						</div>
					</div>
				</div>
			</div>
